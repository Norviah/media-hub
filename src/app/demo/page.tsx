      ...
      <div className='hidden flex-col md:flex'>
        ...
        <div className='flex-1 space-y-4 p-8 pt-6'>
          <div className='flex items-center justify-between space-y-2'>
            <h2 className='font-bold text-3xl text-foreground-dark tracking-tight'>Dashboard</h2>
            ...
            <TabsContent value='overview' className='space-y-4'>
              <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
                <Card>
                  ...
                  <CardContent>
                    <div className='text-2xl font-bold text-card-foreground-dark'>$45,231.89</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className='text-2xl font-bold text-card-foreground-dark'>+2350</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className='text-2xl font-bold text-card-foreground-dark'>+12,234</div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className='text-2xl font-bold text-card-foreground-dark'>+573</div>
          ...
          <div className='space-y-10'>
            <div className='space-y-3'>
              <p className='text-foreground-dark'>
                Ea nisi esse do labore nisi magna eu est magna. Irure fugiat culpa non ullamco
                aliqua ea. Et anim dolor fugiat ad veniam cupidatat deserunt culpa. Exercitation
                cupidatat commodo ad Lorem velit velit culpa ea do.
              </p>

              <p className='text-foreground'>
                Adipisicing nostrud tempor enim ex deserunt. Cupidatat et ullamco officia proident
                exercitation culpa consectetur in culpa id esse. Consectetur est magna et sit enim
                veniam Lorem ex et culpa eiusmod esse. Eiusmod dolore ea culpa minim mollit tempor
                amet id ea ipsum minim elit ea. Laborum culpa laboris veniam minim aute amet velit
                incididunt sit.
              </p>

              <p className='text-foreground-light'>
                Excepteur nisi esse aliquip voluptate excepteur voluptate commodo officia quis non
                incididunt in ut. Deserunt id consectetur id sunt culpa Lorem sint voluptate. Esse
                Lorem ullamco occaecat magna culpa labore eiusmod nostrud.
              </p>

              <p className='text-foreground-lighter'>
                Enim culpa nulla pariatur laborum magna officia velit irure enim adipisicing
                consequat dolor laborum velit. Qui do et in cupidatat irure ut. Tempor non duis elit
                aliquip id nostrud consectetur. Consequat quis exercitation consectetur culpa
                proident dolor irure elit ad enim minim. Ad adipisicing labore aliquip reprehenderit
                fugiat veniam aliqua aliqua consequat.
              </p>
            </div>
            ...
            <div className='space-y-5'>
              <Blockquote>
                There are two types of people; those who try to build the future, and those who try
              ...
              <ul className='space-y-1'>
                <a className='block' target='_self' href='/dashboard/account/me'>
                  <span className='group flex max-w-full cursor-pointer items-center space-x-2 border-default py-1 font-normal outline-none ring-foreground focus-visible:z-10 focus-visible:ring-1 group-hover:border-foreground-muted'>
                    <span
                      title='Preferences'
                      className='w-full truncate text-foreground text-sm transition group-hover:text-foreground-dark'
                    >
                      Preferences
                    </span>
                  </span>
