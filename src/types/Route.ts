...
export interface Route {
  ...
  /**
   * Whether if the route should be displayed in the bottom navigation drawer.
   *
   * This is only applicable if the user is on a mobile device, if false, the
   * route will not be displayed in the bottom navigation drawer.
   */
  mobile: boolean;
